...
//função para contruir a seção about
//async: É como uma promesa, ela tem 3 estagios: resolvida, em pending ou rejected
async function getAboutGitHub(){
    try{
        
        const resposta = await fetch('https://api.github.com/users/SaraCarlenis')
            ...
            <!-- Conteúdo da Seção About -->
             <article class="about-content">
                ...
                <p>
                    ...
                    aprendizado contínuo e paixão por criar soluções eficientes e funcionais.
                </p>
...
//Função para contrução do Carrosel com o Swiper
async function getProjectsGitHub() {
    try{

        const resposta = await fetch('https://api.github.com/users/SaraCarlenis/repos?sort=update&per_page=6')
        ...
        repositorios.forEach( (repositorio) => {
            ...
            const linguagem = repositorio.lenguage || 'GitHub'

            //Seleciona o ícone da lingugem padrão
            const icone = linguagens[linguagem] ?? linguagens['GitHub']

            //Contruir o link do ícone
        ...
        //Pega a descrição do repositorio, se for maior que 100 caracteres ele vai trunca. Se não ele vai devolver o proprio texto
